...
class PlayerPlayoffSeasonAverage(Base):
    __tablename__ = "player_playoff_season_averages"
    ...
    player: Mapped["Player"] = relationship("Player", back_populates="playoff_season_averages")
