...
class TeamPlayoffSeasonAverage(Base):
    __tablename__ = "team_playoff_season_averages"
    ...
    team: Mapped["Team"] = relationship("Team", back_populates="playoff_season_averages")
