    ...
    mock_df = make_schedule_df([
        {
            ...
            "game_datetime_utc": "2024-10-22T19:00:00Z",
            "game_status": 3,
            "game_label": "",
        },
        {
            ...
            "game_datetime_utc": "2024-10-25T19:00:00Z",
            "game_status": 1,
            "game_label": "",
        },
    ])
    ...
    mock_df = make_schedule_df([
        {
            ...
            "game_datetime_utc": "2024-11-01T19:00:00Z",
...
async def test_ingest_schedule_skips_labeled_games(session, test_season, test_home_team, test_away_team):
    mock_df = make_schedule_df([
        ...
        },
        {
            ...
            "home_team_id": test_home_team.id,
            "away_team_id": test_away_team.id,
            "game_datetime_utc": "2025-02-16T19:00:00Z",
            "game_status": 1,
            "game_label": "All-Star",
        },
    ])
